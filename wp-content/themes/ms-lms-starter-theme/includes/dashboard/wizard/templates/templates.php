...
<div class="masterstudy-starter-wizard__wrapper-header">
	...
	<div class="masterstudy-starter-wizard__wrapper-header__price masterstudy-starter-wizard__button-freemius">
		<?php
			echo esc_html__( 'All Premium templates just for', 'masterstudy_starter' );

			$annualPrice = getAnnualPriceFromAPI( 'https://stylemixthemes.com/api/freemius/masterstudy-templates.json' );
			echo esc_attr( ' $' . $annualPrice );
		?>
	</div>
	<?php endif; ?>
...
<div class="masterstudy-starter-wizard__wrapper-content">
	...
	foreach ( $templates as $template ) :
		...
		<li class="masterstudy-starter-wizard__template-<?php echo esc_attr( $template['builder'] ); ?>">
			<div class="masterstudy-starter-wizard__template <?php echo esc_attr( $is_installed ? 'installed' : '' ); ?>">
