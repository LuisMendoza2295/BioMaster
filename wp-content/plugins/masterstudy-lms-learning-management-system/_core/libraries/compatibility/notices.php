...
if ( ! $theme_exists && empty( $start_theme_notice ) ) {
	...
	$init_data['starter-theme'] = array(
		...
		'notice_logo'            => 'ms.svg',
		'notice_title'           => esc_html__( 'Thank you for installing the Masterstudy LMS Plugin.', 'masterstudy-lms-learning-management-system' ),
		'notice_desc'            => esc_html__( 'What to do next, try the Masterstudy Starter theme.', 'masterstudy-lms-learning-management-system' ),
